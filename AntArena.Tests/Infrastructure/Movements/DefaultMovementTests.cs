...
{
    public class DefaultMovementTests
    {
        private readonly DefaultMovement _defaultMovement;
        private readonly Size _arenaSize;
        private readonly Random _random;
        private readonly Bitmap _bitmap;

        public DefaultMovementTests()
        {
            _defaultMovement = new DefaultMovement();
        ...
        {
            // Arrange
            var ant = new AntRed(_arenaSize, _random, _defaultMovement, _bitmap)
            {
                X = -1,
                Y = -1,
            ...
            // Act
            _defaultMovement.Move(ant, _arenaSize);
